...
<sup>4</sup> Paediatric Rheumatology/Special Immunology, Department of Paediatrics, University Hospital Wuerzburg, Wuerzburg, Germany<br />
...
### Plots: Age
```{r, warning=FALSE, echo=TRUE, message=FALSE, comment=FALSE, results = 'hide', fig.width = 10, fig.height = 7}
